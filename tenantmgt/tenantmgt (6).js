    ...
    const handleFilterChange = (fieldName, value, checked) => {
        setFilters((prevFilters) => {
            ...
            if (fieldName === "selectAll") {
                ...
                updatedFilters.about = checked ? filteredData.map((item) => item.about) : [];
            }
            else {
                    ...
                    {showFilterList && (
                        <div className="filter-list-popup">
                            ...
                            <div className="apply-button">
                                <button onClick={() => handleResetFilters('name')}>Reset</button>
                    ...
                    {showAboutFilterList && (
                        <div className="filter-list-popup">
                            ...
                            <div className="filter-item">
                                ...
                                />
                                <label htmlFor="select-all-about" className="selectAllAbout">Select All</label>
                            </div>
                            <div className="filter-scroll">
                                {filteredData
                            ...
                            <div className="apply-button">
                                <button onClick={() => handleResetFilters('about')}>Reset</button>
            ...
            formatter: (cell, row) => (
                <Dropdown>
                    ...
                    <Dropdown.Menu><Dropdown.Item onClick={() => navigate('/viewandedittenant/' + row.tenantID)}>View/Edit</Dropdown.Item>
                        ...
                        <Dropdown.Item onClick={() => handleSubscription(row.tenantID)}>Create Subscription</Dropdown.Item>
                    </Dropdown.Menu>
                </Dropdown>
            )
        }
